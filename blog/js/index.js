function handleScroll() {
    if (window.scrollY > 100 && window.innerWidth > 990) {
...
document.querySelectorAll('.navbar-list > li').forEach((ele) => {
    ele.addEventListener("click", () => {
        document.querySelector(ele.getAttribute("data-target")).scrollIntoView({
            behavior: 'smooth'
        });
    })
})